    ...
    <div>
      ...
      <div>
        {orders.map((order, index)=>(
          <div key = {index}className='grid grid-cols-[0.5fr_2fr_1fr_1fr_1fr] items-start gap-[30px] border border-[rgb(92,22,22)] p-[20px] my-[30px] text-[14px] text-[#505050] md-lg:text-[12px] md-lg:grid-cols-[0.5fr_2fr_1fr] md-lg:py-[15px] md-lg:px-[8px]'>
